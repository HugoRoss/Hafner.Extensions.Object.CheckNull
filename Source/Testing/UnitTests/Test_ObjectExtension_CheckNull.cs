...
public class Test_ObjectExtension_CheckNull {
    ...
    public void CheckNull_NullThrows_Expression() {
        ...
        exception.Message.Should().Match("The result of expression 'GetObject(returnNull: true)' is mandatory and cannot be null!*Parameter *GetObject(returnNull: true)*");
    }
    ...
    public void CheckNull_NullThrows_Parameter_ParameterNameNull() {
        ...
        exception.Message.Should().Match("The argument is mandatory and cannot be null!*Parameter *(unknown)*");
    }
